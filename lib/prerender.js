...
var main = function () {
  var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(port, targetPath, options) {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 90:
            ...
            mockAllParams = function mockAllParams(path, keys) {
              ...
              var _isCombinationValid = function _isCombinationValid(parameters) {
                ...
                if (parameterKeys.length === 1) {
                  ...
                  var parameterRules = options.routerParams[parameterKeys[0]];
                ...
                try {
                  for (var _iterator6 = (0, _getIterator3.default)(parameterKeys), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                    ...
                    var _parameterRules = options.routerParams[parameterKey];
            ...
            _context2.prev = 99;
            _iterator10 = (0, _getIterator3.default)(paths);
          ...
          case 101:
            ...
            _context2.prev = 111;
            _iterator11 = (0, _getIterator3.default)(allPaths);
          ...
          case 127:
            _context2.prev = 127;
            _context2.t1 = _context2['catch'](111);
            _didIteratorError11 = true;
            _iteratorError11 = _context2.t1;
    ...
    }, _callee2, this, [[52, 71, 75, 83], [76,, 78, 82], [99, 144, 148, 156], [111, 127, 131, 139], [132,, 134, 138], [149,, 151, 155]]);
  }));
...
var _parseOptions = function _parseOptions(options) {
  ...
  try {
    for (var _iterator12 = (0, _getIterator3.default)((0, _keys2.default)(options.routerParams)), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
      var routerParam = _step12.value;
      ...
      } else if ((0, _typeof3.default)(options.routerParams[routerParam]) === 'object') {
        var _iteratorNormalCompletion13 = true;
        var _didIteratorError13 = false;
        var _iteratorError13 = undefined;

        try {
          for (var _iterator13 = (0, _getIterator3.default)((0, _keys2.default)(options.routerParams[routerParam])), _step13; !(_iteratorNormalCompletion13 = (_step13 = _iterator13.next()).done); _iteratorNormalCompletion13 = true) {
            var otherRouterParam = _step13.value;
            ...
            if (typeof options.routerParams[routerParam][otherRouterParam] === 'string' || typeof options.routerParams[routerParam][otherRouterParam] === 'number') {
              ...
              var _arr = options.routerParams[routerParam][otherRouterParam];
              options.routerParams[routerParam][otherRouterParam] = {
                _default: _checkArray(_arr)
              };
            } else if ((0, _typeof3.default)(options.routerParams[routerParam][otherRouterParam]) === 'object') {
              var _iteratorNormalCompletion14 = true;
              var _didIteratorError14 = false;
              var _iteratorError14 = undefined;

              try {
                for (var _iterator14 = (0, _getIterator3.default)((0, _keys2.default)(options.routerParams[routerParam][otherRouterParam])), _step14; !(_iteratorNormalCompletion14 = (_step14 = _iterator14.next()).done); _iteratorNormalCompletion14 = true) {
                  var paramValue = _step14.value;
